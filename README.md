...
- `.pkg.sha256` — per-artifact integrity sidecar (`shasum -a 256 -c LiquidCode-*.pkg.sha256`)
...
- Each GitHub Release ships a matching `.pkg.sha256` sidecar for integrity verification.
